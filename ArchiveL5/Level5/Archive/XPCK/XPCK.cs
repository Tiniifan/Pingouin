...
using ArchiveL5.Level5.Compression;
using ArchiveL5.Level5.Compression.NoCompression;
using ArchiveL5.Level5.Compression.ZLib;
using ArchiveL5.Level5.Compression.LZ10;

namespace ArchiveL5.Level5.Archive.XPCK
{
